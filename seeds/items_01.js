...
exports.seed = function(knex, Promise) {
  ...
  return knex('items').del()
    .then(function () {
      ...
      { picture:'./picture/sashimi/tuna.jpg', price: '9.99' , name: 'Tuna Sashimi', description: 'tuna sashimi', category: 'sashimi'},
      { picture:'./picture/sashimi/salmon.jpg', price: '10.99' , name: 'Salmon Sashimi', description: 'salmon sashimi', category: 'sashimi'},
      ...
      { picture:'./picture/roll/CaterpilarRoll.jpg', price: '12.99' , name: 'Tuna Tataki', description: 'Tuna Tataki Sashimi', category: 'roll'},
      ...
      { picture:'./picture/roll/Rainbow.jpg', price: '14.99' , name: 'Rainbow Roll', description: 'Some Rainbow stuffs', category: 'roll'},
      { picture:'./picture/roll/RedDragonRoll.jpg', price: '10.99' , name: 'Red Dragon Roll', description: 'food dis', category: 'roll'},
      { picture:'./picture/roll/SalmonCheeseRoll.jpg', price: '10.99' , name: 'Salmon Cheese Roll', description: 'food dis', category: 'roll'},
